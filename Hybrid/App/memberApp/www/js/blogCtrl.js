        ...
        .controller('BlogCtrl', function ($scope, $rootScope, $ionicModal, $http, $timeout, $window) {
            ...
            $scope.addBlog = function () {
                ...
                $http({
                    ...
                    data: "auth_token=" + authToken + "&user_id=" + userId + "&blog_title=" + $rootScope.currentBlogData.blog_title + "&blog_picture=" + $rootScope.currentBlogData.blog_picture + "&blog_description=" + $rootScope.currentBlogData.blog_description 
