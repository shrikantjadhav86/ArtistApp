...
require_once( APPPATH.'php-graph-sdk-5.0.0/src/Facebook/autoload.php' );
require_once( APPPATH.'php-graph-sdk-5.0.0/src/Facebook/Facebook.php' );
require_once( APPPATH.'php-graph-sdk-5.0.0/src/Facebook/FacebookApp.php' );
require_once( APPPATH.'php-graph-sdk-5.0.0/src/Facebook/FacebookClient.php' );
require_once( APPPATH.'php-graph-sdk-5.0.0/src/Facebook/FacebookCurlHttpClient.php');
require_once( APPPATH.'php-graph-sdk-5.0.0/src/Facebook/HttpClients/FacebookCurl.php');
require_once( APPPATH.'php-graph-sdk-5.0.0/src/Facebook/Helpers/FacebookRedirectLoginHelper.php');
require_once( APPPATH.'php-graph-sdk-5.0.0/src/Facebook/Authentication/OAuth2Client.php');
require_once( APPPATH.'php-graph-sdk-5.0.0/src/Facebook/PersistentData/PersistentDataInterface.php');
require_once( APPPATH.'php-graph-sdk-5.0.0/src/Facebook/Url/UrlDetectionInterface.php');
require_once( APPPATH.'php-graph-sdk-5.0.0/src/Facebook/Url/FacebookUrlDetectionHandler.php');
require_once( APPPATH.'php-graph-sdk-5.0.0/src/Facebook/Helpers/FacebookRedirectLoginHelper.php');
require_once( APPPATH.'php-graph-sdk-5.0.0/src/Facebook/PersistentData/FacebookSessionPersistentDataHandler.php');
require_once( APPPATH.'php-graph-sdk-5.0.0/src/Facebook/PseudoRandomString/PseudoRandomStringGeneratorInterface.php');
require_once( APPPATH.'php-graph-sdk-5.0.0/src/Facebook/PseudoRandomString/PseudoRandomStringGeneratorTrait.php');
require_once( APPPATH.'php-graph-sdk-5.0.0/src/Facebook/PseudoRandomString/McryptPseudoRandomStringGenerator.php');
require_once( APPPATH.'php-graph-sdk-5.0.0/src/Facebook/FacebookRequest.php');
require_once( APPPATH.'php-graph-sdk-5.0.0/src/Facebook/Url/FacebookUrlManipulator.php');
require_once( APPPATH.'php-graph-sdk-5.0.0/src/Facebook/Http/RequestBodyInterface.php');
require_once( APPPATH.'php-graph-sdk-5.0.0/src/Facebook/Http/RequestBodyUrlEncoded.php');
